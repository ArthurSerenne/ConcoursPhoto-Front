...
const ListContest = () => {
  ...
  useEffect(() => {
    ...
    const filtered = contests.filter((contest) => {
      ...
      const ageMatch =
        contest.ageMin >= filterValues.ageRange[0] &&
        contest.ageMax <= filterValues.ageRange[1];
      ...
      switch (filterValues.status?.value) {
        ...
        case 'submission':
          ...
          break;
        case 'result':
          statusMatch = new Date(contest.resultsDate) <= today;
          break;
        default:
          statusMatch = true;
      }
  ...
  const sortedContests = filteredContests
    .filter((contest) => contest.status === true)
