  ...
  useEffect(() => {
    ...
    const filtered = organizations.filter((organization) => {
      ...
      const cityMatch =
        ...
        (organization.city &&
          filterValues.city.some(
            (city) => organization.city.id === city.value
          ));

      const departmentMatch =
        filterValues.department.length === 0 ||
        (organization.zipCode &&
          filterValues.department.some(
            (department) => organization.zipCode.id === department.value
          ));
      ...
      <div className="mx-auto mb-12 mt-12 sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl">
        <div className="flex items-center justify-between">
          <p className="mb-8 text-3xl">
            {filteredOrganization.length} résultats
          </p>
