  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    toast
      .promise(updateProcess(), {
        ...
        error:
          'Erreur lors de la mise à jour des préférences. Veuillez réessayer.',
      })
  ...
  return (
    ...
    >
      <Form>
        <div>
          <div className="mt-10">
            <p className="mb-4 font-bold">Si vous êtes simple membre</p>
            <div className="grid w-full grid-cols-1 space-y-2 bg-gray-100 p-4">
              <label>
                <Field
                  type="checkbox"
                  name="newContest"
              ...
              <label>
                <Field
                  ...
                  className="mr-3 scale-150"
                />
                Être informé par email 48h avant la date de fin des votes d’un
                concours
                <ErrorMessage
                  name="endContest"
                  component="div"
              ...
              <label>
                <Field
                  ...
                  className="mr-3 scale-150"
                />
                Être informé par email lorsque les résultats d’un concours sont
                publiés
                <ErrorMessage
                  name="resultContest"
                  component="div"
              ...
              <label>
                ...
                Être informé par email lorsqu’une nouvel article/actualité est
                publiée dans le blog
                <ErrorMessage
                  name="blog"
                  component="div"
                  className="text-red-500"
          ...
          <div className="mt-10">
            ...
            <div className="grid w-full grid-cols-1 space-y-2 bg-gray-100 p-4">
              <label>
                <Field
                  type="checkbox"
                  name="newContestProfil"
                  className="mr-3 scale-150"
                />
                Être informé lorsqu’un nouveau concours est publié et que mon
                profil satisfait les critères de participation
                <ErrorMessage
                  name="newContestProfil"
                  component="div"
                  className="text-red-500"
              ...
              <label>
                <Field
                  type="checkbox"
                  name="endSubmissionContest"
                  className="mr-3 scale-150"
                />
                Être informé 48h avant la date de fin des soumissions d’un
                concours
                <ErrorMessage
                  name="endSubmissionContest"
                  component="div"
