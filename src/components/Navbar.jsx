...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="flex w-full justify-center bg-[#A8A8A8]">
        <div className="mx-6 flex w-full flex-wrap items-center justify-between py-6 sm:max-w-screen-sm md:mx-24 md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl">
          <a
            href="/"
      ...
      {isLoginModalOpen && (
        <Modal
          ...
          className="relative h-[491px] w-[530px] rounded-lg bg-white pt-6"
        >
      ...
      {isRegisterModalOpen && (
        <Modal
          ...
          overlayClassName="fixed inset-0 bg-black bg-opacity-80 z-50 flex items-center justify-center"
          className="relative w-[530px] rounded-lg bg-white pt-6"
        >
