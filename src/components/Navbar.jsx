        ...
        <nav className="bg-gray-400 w-full top-0 left-0">
            <div className="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-6">
                ...
                <div className="flex md:order-2 gap-2">
                    <Link to="/" className="flex flex-row items-center justify-center rounded bg-neutral-100 py-2.5 px-5 text-sm"><RiUserAddLine /> S'inscrire</Link>
                    <Link to="/" className="flex flex-row items-center justify-center rounded bg-neutral-100 py-2.5 px-5 text-sm"><RiUserSharedLine /> Se connecter</Link>
                </div>
