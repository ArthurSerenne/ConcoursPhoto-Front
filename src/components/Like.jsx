...
const LikeButton = ({ user, photo }) => {
  ...
  return (
    <p
      className={`flex cursor-pointer items-end rounded-full bg-gray-400 px-2 py-2 text-xs uppercase text-white duration-300 ease-in-out hover:bg-gray-300 ${voted ? 'bg-green-500' : ''}`}
